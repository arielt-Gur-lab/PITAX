...
Project schema 4 stores a `pitax-consensus-set-v1` object containing:
...
Still required for biological closure of Stage 3:
...
Ten groups cover the retained taxonomy, QC, curation, Stage 1 evidence, workflow order, Stage 2 architecture, Stage 3 algorithm, AB1 fixtures and Shiny integration contracts.
...
1. Upload `TEST/Stage3_conflict_pair` and import its assignment key in Paired mode.
...
4. Save and reload; confirm the project now uses schema 4.
