PITAX v3.0.0-alpha.9.2 — organized development baseline
=========================================================
...
Expected final line:
  ...
  All PITAX v3.0.0-alpha.9.2 tests passed.

The suite now has 14 groups. Stage 4 tests prove duplicate Isolate/Locus
