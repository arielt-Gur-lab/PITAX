# PITAX v3.0.0-alpha.6 - Stage 1 AB1 evidence helper regression tests.
...
source(file.path(app_dir, "R", "domain", "sanger", "ab1_evidence.R"))
...
cat("v3.0.0-alpha.6 AB1 evidence helper tests passed.\n")
