...
must_contain(app_text, 'source(file.path("R", "domain", "multilocus", "stage4_multilocus.R"), local = TRUE)')
...
must_contain(app_text, 'if (source_schema <= 4L) st <- stage4_migrate_v4_state(st)')
